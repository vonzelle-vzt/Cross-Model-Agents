...
# Repository-local hooks only. Shared with the Node installer so both preserve
# existing hook managers and never rewrite the user's global hooksPath.
node "$SCRIPT_DIR/install-hooks.js"
